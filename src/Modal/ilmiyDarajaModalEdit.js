...
import {OnClick_SaveEdit, ToggleModalEdit} from "../features/card/cartSlice_ilmiyDaraja";


function IlmiyDarajaModalEdit({id}) {


    const dispatch = useDispatch()
    const {modalVisibleEDIT} = useSelector((store) => store.cart3)
...
export default IlmiyDarajaModalEdit;